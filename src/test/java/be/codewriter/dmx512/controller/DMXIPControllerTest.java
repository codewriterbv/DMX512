...
class DMXIPControllerTest {
    ...
    void shouldHaveValidArtNetPoll() {
        ...
        var poll = builder.createArtPollPacket();
        assertEquals("41 72 74 2D 4E 65 74 00 00 20 00 0E 00 00", HexTool.toHexString(poll), "Art-Net Poll");
    }

    @Test
    void shouldHaveValidArtNetDataFromClient() throws UnknownHostException {
    ...
    @Test
    void shouldHaveValidArtNetDataFromClients() throws UnknownHostException {
        var client1 = MotherObjects.fiveChannelClient((byte) 0x01, (byte) 0x02, (byte) 0x03, (byte) 0x04, (byte) 0x05, 1);
    ...
    @Test
    void shouldHaveValidArtNetDataFromBytes() throws UnknownHostException {
